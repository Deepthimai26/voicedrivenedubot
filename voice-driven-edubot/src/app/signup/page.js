...
export default function SignupPage() {
    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
      <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        ...
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
          <div>
           <h2 className="text-4xl text-indigo-500 text-center font-extrabold font-[lucida] italic">Voice EduBot</h2>
          </div>
  ...
  <a href="/terms" className="border-b border-gray-500 border-dotted hover:text-purple-600">
    Terms of Service
  </a>{" "}
  and{" "}
  <a href="/privacy" className="border-b border-gray-500 border-dotted hover:text-purple-600">
    Privacy Policy
  </a>.
</p>
